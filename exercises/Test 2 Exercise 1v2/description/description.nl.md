...
# <b>Opdracht</b>
Maak een functie genaamd <function name="BetoogLengte"></function> die één getal (<i>integer</i>) als invoer neemt (het aantal woorden dat een betoog bevat), en dan een bericht teruggeeft die aangeeft hoe lang dat betoog is.
- Als het betoog minder dan 300 woorden heeft: <code>"Dit is een kort betoog."</code>
- Als het betoog tussen de 300 en 800 woorden heeft (inclusief 300 en 800): <code>"Dit is een normaal betoog."</code>
- Als het betoog meer dan 800 woorden heeft: <code>"Dit is een lang betoog."</code>
...
<table>
  ...
  <tbody>
    <tr>
      <td><function name="BetoogLengte" inputs='90'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Dit is een kort betoog."</code></td>
    </tr>
    <tr>
      <td><function name="BetoogLengte" inputs='300'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Dit is een normaal betoog."</code></td>
    </tr>
    <tr>
      <td><function name="BetoogLengte" inputs='593'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Dit is een normaal betoog."</code></td>
    </tr>
    <tr>
      <td><function name="BetoogLengte" inputs='800'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Dit is een normaal betoog."</code></td>
    </tr>
    <tr>
      <td><function name="BetoogLengte" inputs='1050'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Dit is een lang betoog."</code></td>
    </tr>
  </tbody>
</table>
</div>
