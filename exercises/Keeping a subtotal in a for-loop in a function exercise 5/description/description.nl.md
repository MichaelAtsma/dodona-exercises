...
# <b>Opdracht</b>
Maak een functie genaamd <function name="LangsteWoord"></function> die een lijst van woorden als invoer neemt. De functie moet het langste woord in de lijst teruggeven. Je mag aannemen dat er altijd exact één langste woord is, dus:

<ul>
  <li>...dat er geen twee woorden van dezelfde lengte zijn.</li>
  <li>...dat de lijst niet leeg is.</li>
</ul>
...
<table>
  ...
  <tbody>
    <tr>
      <td><function name="LangsteWoord" inputs='["appel", "banaan", "kers"]'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"banaan"</code></td>
    </tr>
    <tr>
      <td><function name="LangsteWoord" inputs='["kat", "hond", "aap", "olifant"]'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"olifant"</code></td>
    </tr>
  </tbody>
</table>
</div>
...
In plaats van een getal bijhouden als subtotaal kan je ook een <i>string</i> bijhouden.
