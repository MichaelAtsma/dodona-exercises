...
# <b>Opdracht</b>
Maak een functie genaamd <function name="EvenOfOneven"></function> die één getal als invoer neemt, en dan bij positieve getallen teruggeeft of het getal even of oneven is:
- Als het getal niet positief is, geef dan de tekst <code>"Geen positief getal"</code> terug.
- Als het getal even is, geef dan de tekst <code>"Even"</code> terug.
- Als het getal oneven is, geef dan de tekst <code>"Oneven"</code> terug.
...
<table>
  ...
  <tbody>
    <tr>
      <td><function name="EvenOfOneven" inputs='5'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Oneven"</code></td>
    </tr>
    <tr>
      <td><function name="EvenOfOneven" inputs='12'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Even"</code></td>
    </tr>
    <tr>
      <td><function name="EvenOfOneven" inputs='-7'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Geen positief getal"</code></td>
    </tr>
    <tr>
      <td><function name="EvenOfOneven" inputs='0'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Geen positief getal"</code></td>
    </tr>
  </tbody>
