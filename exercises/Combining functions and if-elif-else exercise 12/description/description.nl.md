...
<table>
  ...
  <tbody>
    <tr>
      <td><function name="SnelheidsBord" inputs='40,30'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"U rijdt te snel!"</code></td>
    </tr>
    <tr>
      <td><function name="SnelheidsBord" inputs='45,50'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Dankuwel."</code></td>
    </tr>
    <tr>
      <td><function name="SnelheidsBord" inputs='120,120'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Rijd voorzichtig alstublieft."</code></td>
    </tr>
  </tbody>
</table>
</div>
