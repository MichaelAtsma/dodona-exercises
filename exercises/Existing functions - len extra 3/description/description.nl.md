...
Je hebt gezien dat de <function name="len"></function> functie de lengte van de invoertekst berekent. Je gaat die functie hier toepassen op verschillende invoeren.

<br>
<hr>

# <b>Opdracht</b>
1. Maak een variabele <code>a</code> aan die een tekst (<i>string</i>) opslaat die je zelf goed moet kiezen (zie stap 2).
2. Maak een variabele <code>b</code> aan die de lengte van <code>a</code> berekent. Zorg dat de waarde van <code>b</code> uitkomt op <code>15</code>. Kies de waarde van <code>a</code> dus correct.