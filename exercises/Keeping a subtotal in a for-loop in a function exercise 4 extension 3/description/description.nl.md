...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><pre><code>3 van de 7 leerlingen zijn geslaagd.</code></pre></td>
    </tr>
    <tr>
      <td><function name="AantalGeslaagd" inputs='[49.9, 50.0, 50.1]'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>2 van de 3 leerlingen zijn geslaagd.</code></pre></td>
    </tr>
    <tr>
      <td><function name="AantalGeslaagd" inputs='[80, 20, 60, 30, 80, 90, 100, 10]'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>5 van de 8 leerlingen zijn geslaagd.</code></pre></td>
    </tr>
    <tr>
      <td><function name="AantalGeslaagd" inputs='[80]'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>1 van de 1 leerlingen zijn geslaagd.</code></pre><br><i>*We gaan deze grammaticafout niet oplossen</i></td>
    </tr>
    <tr>
      <td><function name="AantalGeslaagd" inputs='[40]'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>0 van de 1 leerlingen zijn geslaagd.</code></pre><br><i>*We gaan deze grammaticafout niet oplossen</i></td>
    </tr>
    <tr>
      <td><function name="AantalGeslaagd" inputs='[]'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>0 van de 0 leerlingen zijn geslaagd.</code></pre></td>
    </tr>
  </tbody>
</table>
</div>
