...
Soms moet je je lus niet bij 0 beginnen. Gelukkig kan je de <function name="range"></function> functie nog meer informatie geven. Je kan bijvoorbeeld de getallen van 6 <i>tot</i> 15 afgaan. Dit doe je met <function name="range" inputs="6, 15"></function>. Het eerste getal is het startpunt (inclusief), en het tweede getal is het eindpunt (exclusief). Dus <function name="range" inputs="6, 15"></function> genereert de getallen 6, 7, 8, 9, 10, 11, 12, 13, 14. Zie het voorbeeld hieronder:
...
Wat gebeurt hier?
<ul>
  <li><function name="range" inputs="6, 15"></function> genereert de getallen <code>6</code>, <code>7</code>, <code>8</code>, <code>9</code>, <code>10</code>, <code>11</code>, <code>12</code>, <code>13</code>, <code>14</code>.</li>
  <li>In het begin krijgt <code>i</code> de waarde <code>6</code>.</li>
  <li>Dan wordt <function name="print" inputs='i'></function> uitgevoerd, waardoor <code class="string">6</code> op het scherm verschijnt.</li>
  <li>Daarna krijgt <code>i</code> de volgende waarde, namelijk <code>7</code>.</li>
  <li>Dan wordt <function name="print" inputs='i'></function> uitgevoerd, waardoor <code class="string">7</code> op het scherm verschijnt.</li>
  <li>...</li>
  <li>Als laatste krijgt <code>i</code> de waarde <code>14</code>.</li>
  <li>Dan wordt <function name="print" inputs='i'></function> uitgevoerd, waardoor <code class="string">14</code> op het scherm verschijnt.</li>
  <li>Nu zijn er geen getallen meer in de reeks die door <function name="range" inputs="6, 15"></function> is gegenereerd, want de 15 is exclusief, dus stopt de lus.</li>
</ul>
