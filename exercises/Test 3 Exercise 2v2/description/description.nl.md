...
# <b>Opdracht</b>
Maak een functie<span class="enable-select"> <function name="SchoolMotto"></function> </span>die een woord (<i>string</i>) als invoer neemt, dan telt hoevaak de hoofdletters van het schoolmotto GOKAE voorkomen en hoeveel andere letters er voorkomen, en dan deze aantallen op het scherm afdrukt in het volgende formaat: <code class="string">WOORD bevat # GOKAE letters en # andere letters.</code>, waarbij <code>WOORD</code> de gegeven tekst is en de <code>#</code> de respectievelijke aantallen zijn. Let op dat de GOKAE letters enkel tellen als het hoofdlettrs zijn, kleine letters worden niet meegeteld als GOKAE letters. Je mag er van uitgaan dat de invoer enkel letters bevat (dus geen spaties, cijfers of speciale tekens).
...
<table>
  ...
  <tbody>
    <tr>
      <td><function name="SchoolMotto" inputs='"vOorbEelD"'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>vOorbEelD bevat 2 GOKAE letters en 7 andere letters.</code></pre></td>
    </tr>
    <tr>
      <td><function name="SchoolMotto" inputs='"michiEls"'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>michiEls bevat 1 GOKAE letters en 7 andere letters.</code></pre></td>
    </tr>
    <tr>
      <td><function name="SchoolMotto" inputs='"AtsmA"'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>AtsmA bevat 2 GOKAE letters en 3 andere letters.</code></pre></td>
    </tr>
    <tr>
      <td><function name="SchoolMotto" inputs='"iKKanprOgrAmmeren"'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>iKKanprOgrAmmeren bevat 4 GOKAE letters en 13 andere letters.</code></pre></td>
    </tr>
    <tr>
      <td><function name="SchoolMotto" inputs='"GOKAEgokae"'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>GOKAEgokae bevat 5 GOKAE letters en 5 andere letters.</code></pre></td>
    </tr>
  </tbody>
</table>
</div>
