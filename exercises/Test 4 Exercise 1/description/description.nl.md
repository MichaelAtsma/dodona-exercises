...
>>> NummerAnalyse(123, 7)
Het product en de som van de cijfers zijn allebei gelijk aan 6.
123 is niet deelbaar door 7, het resultaat is ongeveer 17.57.
>>> NummerAnalyse(456, 2)
Het product van de cijfers (120) is groter dan de som van de cijfers (15).
456 is een veelvoud van 2.
>>> NummerAnalyse(111112, 3)
Het product van de cijfers (2) is kleiner dan de som van de cijfers (7).
111112 is niet deelbaar door 3, het resultaat is ongeveer 37037.33.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Het product van de cijfers van `123` is $$1 \cdot 2 \cdot 3 = 6$$.<br>De som van de cijfers van `123` is $$1 + 2 + 3 = 6$$.<br>Het product en de som zijn dus gelijk.<br>$$123 / 7 \approx 17.57$$</td>
    </tr>
    <tr>
      ...
      <td>Het product van de cijfers van `456` is $$4 \cdot 5 \cdot 6 = 120$$.<br>De som van de cijfers van `456` is $$4 + 5 + 6 = 15$$.<br>Het product is dus groter dan de som.<br>$$456 / 2 = 228$$</td>
    </tr>
    <tr>
      ...
      <td>Het product van de cijfers van `111112` is $$1 \cdot 1 \cdot 1 \cdot 1 \cdot 1 \cdot 2 = 2$$.<br>De som van de cijfers van `111112` is $$1 + 1 + 1 + 1 + 1 + 2 = 7$$.<br>Het product is dus kleiner dan de som.<br>$$111112 / 3 \approx 37037.33$$</td>
  </tbody>
</table>
</div>
