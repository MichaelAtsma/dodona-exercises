...
Het heeft echter weinig zin om in je voorwaarde een vergelijking te maken tussen twee getallen waarvan je van tevoren ook al kan weten of het True of False gaat zijn. Meestal wil je juist dat de regel(s) onder je <i>if</i>-statement wel of niet worden uitgevoerd afhankelijk van de waarde van één (of meerdere) van je variabelen.
