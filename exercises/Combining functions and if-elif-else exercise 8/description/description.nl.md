...
# <b>Opdracht</b>
Maak een functie genaamd <function name="SterkWachtwoord"></function> die één <i>string</i> als invoer neemt (een wachtwoord), en dan teruggeeft of het wachtwoord sterk genoeg is:
- Als het wachtwoord minder dan 8 tekens heeft, geef dan de tekst <code>"Wachtwoord te kort"</code> terug.
- Als het wachtwoord precies 8 tekens heeft, geef dan de tekst <code>"Wachtwoord oké"</code> terug.
- Als het wachtwoord meer dan 8 tekens heeft, geef dan de tekst <code>"Wachtwoord sterk"</code> terug.
...
<table>
  ...
  <tbody>
    <tr>
      <td><function name="SterkWachtwoord" inputs='"kort"'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Wachtwoord te kort"</code></td>
    </tr>
    <tr>
      <td><function name="SterkWachtwoord" inputs='"precies8"'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Wachtwoord oké"</code></td>
    </tr>
    <tr>
      <td><function name="SterkWachtwoord" inputs='"eenlangwachtwoord"'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Wachtwoord sterk"</code></td>
    </tr>
  </tbody>
</table>
</div>
