...
<ul>
  ...
  <li>Lijst 2 is <code>["Ik", "kan", "programmeren"]</code></li>
</ul>
...
<table>
  ...
  <tbody>
    <tr>
      <td><function name="AantalKarakters" inputs='["hallo", "wereld!"], ["Ik", "kan", "programmeren"]'></function></td>
      <td style="text-align: center;">→</td>
      <td><code class="string">29</code></td>
      <td>Lijst 1 bevat 12 karakters (5+7) en Lijst 2 bevat 17 karakters (2+3+12), dus dat is samen 29.</td>
    </tr>
    <tr>
      ...
      <td style="text-align: center;">→</td>
      <td><code class="string">88</code></td>
      <td>Lijst 1 bevat 44 karakters (24+20) en Lijst 2 bevat 44 karakters (42+2), dus dat is samen 88.</td>
    </tr>
    <tr>
      <td><function name="AantalKarakters" inputs='["a", "bcd"], []'></function></td>
      <td style="text-align: center;">→</td>
      <td><code class="string">4</code></td>
      <td>Lijst 1 bevat 4 karakters (1+3), en Lijst 2 bevat 0 karakters, dus dat is samen 4.</td>
    </tr>
  </tbody>
</table>
</div>
