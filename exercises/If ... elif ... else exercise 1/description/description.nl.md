...
# <b>Opdracht</b>
Vervang de <b>underscores</b> (<code>____</code>) in de code zodat het bericht aan het einde van het programma <code>Oei, je hebt het echt op het nippertje gehaald, gefeliciteerd!</code> is:
