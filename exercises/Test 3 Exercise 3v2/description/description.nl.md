...
# <b>Opdracht</b>
Maak een functie <function name="SomDelers"></function> die één geheel getal (<i>integer</i>) als invoer neemt. De functie bepaalt de som van alle delers van dat getal, inclusief 1 en het getal zelf. De functie geeft deze som terug als uitvoer.
...
<table>
  ...
  <tbody>
    <tr>
      <td><function name="SomDelers" inputs='2'></function></td>
      <td style="text-align: center;">→</td>
      <td><code class="boolean">3</code></td>
      <td>De delers van 2 zijn 1 en 2. De som is 3.</td>
    </tr>
    <tr>
      <td><function name="SomDelers" inputs='3'></function></td>
      <td style="text-align: center;">→</td>
      <td><code class="boolean">4</code></td>
      <td>De delers van 3 zijn 1 en 3. De som is 4.</td>
    </tr>
    <tr>
      <td><function name="SomDelers" inputs='4'></function></td>
      <td style="text-align: center;">→</td>
      <td><code class="boolean">7</code></td>
      <td>De delers van 4 zijn 1, 2, en 4. De som is 7.</td>
    </tr>
    <tr>
      <td><function name="SomDelers" inputs='15'></function></td>
      <td style="text-align: center;">→</td>
      <td><code class="boolean">24</code></td>
      <td>De delers van 15 zijn 1, 3, 5, en 15. De som is 24.</td>
    </tr>
    <tr>
      <td><function name="SomDelers" inputs='1'></function></td>
      <td style="text-align: center;">→</td>
      <td><code class="boolean">1</code></td>
      <td>De delers van 1 zijn 1. De som is 1.</td>
    </tr>
    <tr>
      <td><function name="SomDelers" inputs='113'></function></td>
      <td style="text-align: center;">→</td>
      <td><code class="boolean">114</code></td>
      <td>De delers van 113 zijn 1 en 113. De som is 114.</td>
    </tr>
  </tbody>
</table>
</div>
