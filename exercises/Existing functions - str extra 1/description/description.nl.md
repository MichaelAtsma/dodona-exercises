...
Je hebt gezien dat de <function name="str"></function> functie van de invoer een tekst maakt. Je gaat die functie hier toepassen op verschillende invoeren.

<br>
<hr>

# <b>Opdracht</b>
1. Maak een variabele <code>a</code> aan die een geheel getal (<i>integer</i>) opslaat met een waarde die je zelf goed moet kiezen (zie stap 2).
2. Maak een variabele <code>b</code> aan die de waarde van <code>a</code> omgezet naar een tekst (<i>string</i>) opslaat. Zorg dat de waarde van <code>b</code> uitkomt op <code>"10"</code>. Kies de waarde van <code>a</code> dus correct.