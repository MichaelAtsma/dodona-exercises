...
# <b>Opdracht</b>
Breid de <function name="AantalGeslaagd"></function> functie van de vorige oefening uit. De functie neemt een lijst van cijfers als invoer. De functie moet nog steeds het aantal leerlingen dat geslaagd is (50 of hoger heeft behaald) op het scherm afdrukken met de volgende zin: <code class="string">Er zijn [X] leerlingen geslaagd.</code>, waarbij <code class="string">X</code> vervangen wordt met het juiste getal.

<span style="color: red;"><b>Toevoeging</b></span>: we lossen nu de grammaticafout op. Als er maar 1 leerling geslaagd is, moet de functie de volgende zin afdrukken: <code class="string">Er is 1 leerling geslaagd.</code>.
...
<table>
  ...
  <tbody>
    <tr>
      <td><function name="AantalGeslaagd" inputs='[10, 20, 30, 40, 50, 60, 70]'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>Er zijn 3 leerlingen geslaagd.</code></pre></td>
    </tr>
    <tr>
      <td><function name="AantalGeslaagd" inputs='[49.9, 50.0, 50.1]'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>Er zijn 2 leerlingen geslaagd.</code></pre></td>
    </tr>
    <tr>
      <td><function name="AantalGeslaagd" inputs='[80, 20, 60, 30, 80, 90, 100, 10]'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>Er zijn 5 leerlingen geslaagd.</code></pre></td>
    </tr>
    <tr>
      <td><function name="AantalGeslaagd" inputs='[80]'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>Er is 1 leerling geslaagd.</code></pre></td>
    </tr>
    <tr>
      <td><function name="AantalGeslaagd" inputs='[40]'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>Er zijn 0 leerlingen geslaagd.</code></pre></td>
    </tr>
  </tbody>
</table>
</div>
