...
<table>
  ...
  <tbody>
    <tr>
      <td><function name="VerwelkomIedereen" inputs='["Ahmed", "Bryan", "Charlie", "Dustin"]'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>Welkom Ahmed!<br>Welkom Bryan!<br>Welkom Charlie!<br>Welkom Dustin!</code></pre></td>
    </tr>
    <tr>
      <td><function name="VerwelkomIedereen" inputs='["Elodie", "Fiona", "George"]'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>Welkom Elodie!<br>Welkom Fiona!<br>Welkom George!</code></pre></td>
    </tr>
    <tr>
      <td><function name="VerwelkomIedereen" inputs='["Hiba", "Inès", "Jialue", "Karim", "Lara"]'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>Welkom Hiba!<br>Welkom Inès!<br>Welkom Jialue!<br>Welkom Karim!<br>Welkom Lara!</code></pre></td>
    </tr>
    <tr>
      <td><function name="VerwelkomIedereen" inputs='["Max", "Noemie", "Oscar", "Paulin", "Quirine"]'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>Welkom Max!<br>Welkom Noemie!<br>Welkom Oscar!<br>Welkom Paulin!<br>Welkom Quirine!</code></pre></td>
    </tr>
    <tr>
      <td><function name="VerwelkomIedereen" inputs='["Rocco", "Saniya", "Thibault", "Uma", "Victoria"]'></function></td>
      <td style="text-align: center;">→</td>
