...
# <b>Opdracht</b>
Maak een functie <function name="MeesteKarakters"></function> die twee lijsten als invoer neemt en op het scherm afdrukt welke lijst in totaal de meeste karakters bevat. Je drukt dus één van de volgende drie zinnen af, afhankelijk van welke lijst de meeste karakters bevat:

<ul>
  <li><code class="string">De eerste lijst bevat de meeste karakters.</code></li>
  <li><code class="string">De tweede lijst bevat de meeste karakters.</code></li>
  <li><code class="string">Beide lijsten bevatten evenveel karakters.</code></li>
</ul>
...
<table>
  ...
  <tbody>
    <tr>
      <td><function name="MeesteKarakters" inputs='["hallo", "wereld!"], ["Ik", "kan", "programmeren"]'></function></td>
      <td style="text-align: center;">→</td>
      <td><code class="string">De tweede lijst bevat de meeste karakters.</code></td>
      <td>Lijst 1 bevat 12 karakters (5+7) en Lijst 2 bevat 17 karakters (2+3+12).</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align: center;">→</td>
      <td><code class="string">De eerste lijst bevat de meeste karakters.</code></td>
      <td>Lijst 1 bevat 4 karakters (1+3), en Lijst 2 bevat 0 karakters.</td>
    </tr>
  </tbody>
</table>
</div>
