...
- Als er meer dan 10 mm regen wordt voorspeld: <code>"Er wordt vandaag zware regen verwacht."</code>

<i>Je mag aannemen dat er geen negatieve invoerwaarden gegeven worden.</i>
...
<table>
  ...
  <tbody>
    <tr>
      <td><function name="RegenVoorspelling" inputs='0'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Het blijft droog vandaag."</code></td>
    </tr>
    <tr>
      <td><function name="RegenVoorspelling" inputs='3'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Er wordt vandaag lichte regen verwacht."</code></td>
    </tr>
    <tr>
      <td><function name="RegenVoorspelling" inputs='5.1'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Er wordt vandaag matige regen verwacht."</code></td>
    </tr>
    <tr>
      <td><function name="RegenVoorspelling" inputs='8.4'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Er wordt vandaag matige regen verwacht."</code></td>
    </tr>
    <tr>
      <td><function name="RegenVoorspelling" inputs='10'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Er wordt vandaag matige regen verwacht."</code></td>
    </tr>
    <tr>
      <td><function name="RegenVoorspelling" inputs='10.1'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Er wordt vandaag zware regen verwacht."</code></td>
    </tr>
    <tr>
      <td><function name="RegenVoorspelling" inputs='23'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Er wordt vandaag zware regen verwacht."</code></td>
    </tr>
  </tbody>
