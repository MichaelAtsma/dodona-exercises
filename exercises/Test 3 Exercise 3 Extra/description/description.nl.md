...
<span style="color: red;"><b>Deze extra oefening heeft minder testgevallen dan de gewone oefening, maar telt niet mee voor het eindresultaat. Je kunt deze extra oefening gebruiken om sneller te testen of je code werkt, voordat je klaar bent om de gewone oefening in te dienen. Test ook even of je je code kan kopiëren en plakken in de andere oefening.</b></span>

# <b>Opdracht</b>
Maak een functie <function name="IsDeelbaar"></function> die één geheel getal (<i>integer</i>) als invoer neemt. De functie bepaalt of het ingevoerde getal deelbaar is door een ander getal dan <code>1</code> en zichzelf (ofwel: deelbaar is door méér dan twee getallen), en geeft <code class="boolean">True</code> terug als dat het geval is, en <code class="boolean">False</code> als dat niet het geval is.
