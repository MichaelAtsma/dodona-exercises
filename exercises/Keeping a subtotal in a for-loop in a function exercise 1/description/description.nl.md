...
# <b>Opdracht</b>
Maak een functie genaamd <function name="SomVanKwadraten"></function> die één invoer heeft, namelijk een lijst van getallen (<i>integers</i>). De functie zal met een <i>for</i>-lus de som van de kwadraten van de getallen in de lijst berekenen en teruggeven.
...
<table>
  ...
  <tbody>
    <tr>
      <td><function name="SomVanKwadraten" inputs='[10, 5, 3]'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>134</code></pre></td>
    </tr>
    <tr>
      <td><function name="SomVanKwadraten" inputs='[1, 2, 4, 8, 16, 32]'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>1365</code></pre></td>
    </tr>
    <tr>
      <td><function name="SomVanKwadraten" inputs='[2, 3, 4]'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>29</code></pre></td>
    </tr>
    <tr>
      <td><function name="SomVanKwadraten" inputs='[]'></function></td>
      <td style="text-align: center;">→</td>
