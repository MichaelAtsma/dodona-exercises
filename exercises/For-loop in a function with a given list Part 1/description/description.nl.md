...
Vervang de underscores zodat elk element van de gegeven lijst op een nieuwe regel wordt afgedrukt, zoals je in input-output verwachtingen hieronder kan zien.
...
<table>
  ...
  <tbody>
    <tr>
      <td><function name="PrintAllesInDeLijst" inputs='["appels", "broccoli", "citroenen", "druiven"]'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>appels<br>broccoli<br>citroenen<br>druiven</code></pre></td>
    </tr>
    <tr>
      <td><function name="PrintAllesInDeLijst" inputs='[9, 2, 18]'></function></td>
      <td style="text-align: center;">→</td>
...
<i>(Je hoeft enkel de underscores te vervangen, de rest van de code kan je laten zoals het is.)</i>