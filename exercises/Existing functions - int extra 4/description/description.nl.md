...
We zullen hier eens opnieuw kijken naar de speciale gevallen van het omzetten van een <i>float</i> naar een <i>integer</i>. Herinner je nog dat <function name="int" inputs='5.2'></function> als uitkomst het geheel getal <code>5</code> geeft (in plaats van het <i>kommagetal</i> <code>5.2</code>).
