...
# <b>Opdracht</b>
Maak een functie <function name="DnaComplement"></function> die een tekst (<i>string</i>) als invoer neemt (een DNA-streng). De functie geeft het complement van de DNA-streng terug.
...
<table>
  ...
  <tbody>
    <tr>
      <td><function name="DnaComplement" inputs='"ACGTACGT"'></function></td>
      <td style="text-align: center;">→</td>
      <td><code class="string">'TGCATGCA'</code></td>
    </tr>
    <tr>
      <td><function name="DnaComplement" inputs='"ACAACAGT"'></function></td>
      <td style="text-align: center;">→</td>
      <td><code class="string">'TGTTGTCA'</code></td>
    </tr>
    <tr>
      <td><function name="DnaComplement" inputs='"AATTACA"'></function></td>
      <td style="text-align: center;">→</td>
      <td><code class="string">'TTAATGT'</code></td>
    </tr>
    <tr>
      <td><function name="DnaComplement" inputs='""'></function></td>
      <td style="text-align: center;">→</td>
...
<details markdown="1"><summary>Tip (de resultante string opbouwen)</summary>

Herinner je dat we <i>strings</i> bij elkaar kunnen optellen om een nieuwe <i>string</i> te maken.

</details> <!-- End of tip (de resultante string opbouwen) -->
