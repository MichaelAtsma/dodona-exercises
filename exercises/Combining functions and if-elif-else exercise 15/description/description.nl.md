...
<table>
  ...
  <tbody>
    <tr>
      <td><function name="KlasGrootte" inputs='-5'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Dit is geen valide invoer."</code></td>
    </tr>
    <tr>
      <td><function name="KlasGrootte" inputs='0'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"De klas is leeg."</code></td>
    </tr>
    <tr>
      <td><function name="KlasGrootte" inputs='5'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Dit is een kleine klas."</code></td>
    </tr>
    <tr>
      <td><function name="KlasGrootte" inputs='15'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Dit is een kleine klas."</code></td>
    </tr>
    <tr>
      <td><function name="KlasGrootte" inputs='18'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Dit is een gemiddelde klas."</code></td>
    </tr>
    <tr>
      <td><function name="KlasGrootte" inputs='21'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Dit is een grote klas."</code></td>
    </tr>
    <tr>
      <td><function name="KlasGrootte" inputs='27'></function></td>
      <td style="text-align: center;">→</td>
      <td><code>"Dit zijn te veel leerlingen voor één klas."</code></td>
    </tr>
  </tbody>
</table>
</div>
