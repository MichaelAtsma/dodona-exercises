...
def evaluate_test(context, match_regex, mandatory_texts_and_descriptions, forbidden_texts_and_descriptions, correct_message_template, wrong_value_message_template):
    ...
    if correct:
        ...
        if not checks["variable name correctly used again"]:
            mymessages.append(Message(f"Zorg ervoor dat je dezelfde variabele naam gebruikt in de print-functie als in de for-lus. Anders weet de computer niet welke variabele je bedoelt."))
