...
# <b>Opdracht</b>
Maak een functie <function name="ProductDelers"></function> die één geheel getal (<i>integer</i>) als invoer neemt. De functie bepaalt het product van alle delers van dat getal, inclusief 1 en het getal zelf. De functie drukt dan het resultaat op het scherm af in het volgende formaat: <code class="string">Het product van de delers van GEGEVENGETAL is PRODUCT.</code>, waarbij <code class="string">GEGEVENGETAL</code> het ingevoerde getal is en <code class="string">PRODUCT</code> het berekende product van de delers.
...
<table>
  ...
  <tbody>
    <tr>
      <td><function name="ProductDelers" inputs='2'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>Het product van de delers van 2 is 2.</code></pre></td>
      <td>De delers van 2 zijn 1 en 2. Het product is 2.</td>
    </tr>
    <tr>
      <td><function name="ProductDelers" inputs='4'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>Het product van de delers van 4 is 8.</code></pre></td>
      <td>De delers van 4 zijn 1, 2, en 4. Het product is 8.</td>
    </tr>
    <tr>
      <td><function name="ProductDelers" inputs='15'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>Het product van de delers van 15 is 225.</code></pre></td>
      <td>De delers van 15 zijn 1, 3, 5, en 15. Het product is 225.</td>
    </tr>
    <tr>
      <td><function name="ProductDelers" inputs='1'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>Het product van de delers van 1 is 1.</code></pre></td>
      <td>De delers van 1 zijn 1. Het product is 1.</td>
    </tr>
    <tr>
      <td><function name="ProductDelers" inputs='113'></function></td>
      <td style="text-align: center;">→</td>
      <td><pre><code>Het product van de delers van 113 is 113.</code></pre></td>
      <td>De delers van 113 zijn 1 en 113. Het product is 113.</td>
    </tr>
    <tr>
