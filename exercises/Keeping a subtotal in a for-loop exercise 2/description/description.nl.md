...
<i>(Vervang enkel de underscores, laat de rest van de code zoals het is. Laat de underscores in de variabele <code>som_van_kwadraten</code> staan, je moet enkel de langere underscores vervangen.)</i>
