...
# <b>Opdracht</b>
Maak een functie genaamd <function name="PositiefOfNegatief"></function> die één getal als invoer neemt, en een tekst teruggeeft afhankelijk van of dat getal positief (of 0) is, of negatief. Indien het positief (of 0) is moet de tekst `"Dit getal is positief"`{:.language-python} zijn, en indien het negatief is moet de tekst <code>"Dit getal is negatief"</code> zijn.
...
<ul>
  ...
  <li><function name="PositiefOfNegatief" inputs="0"></function> geeft de tekst <code>"Dit getal is positief"</code> terug (want <code>0</code> is positief of 0).</li>
  <li><function name="PositiefOfNegatief" inputs="-2.4"></function> geeft de tekst <code>"Dit getal is negatief"</code> terug (want <code>-2.4</code> is negatief).</li>
</ul>
</details>
